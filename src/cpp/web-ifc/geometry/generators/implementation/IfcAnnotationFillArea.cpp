...
namespace webifc::geometry::generators {
	glm::dvec4 GenerateIfcAnnotationFillArea(const uint32_t expressID, const uint32_t lineType, webifc::parsing::IfcLoader &loader, webifc::cache::IfcCache &cache, GeometryGeneratorSettings &settings) {
