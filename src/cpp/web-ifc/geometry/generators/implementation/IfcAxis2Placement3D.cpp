...
namespace webifc::geometry::generators {
	glm::dmat4 GenerateIfcAxis2Placement3D(const uint32_t expressID, const uint32_t lineType, webifc::parsing::IfcLoader &loader, webifc::cache::IfcCache &cache, GeometryGeneratorSettings &settings) {
